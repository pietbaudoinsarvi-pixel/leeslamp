...
const SHELL = ['./', './index.html', './app.js', './lookup.js', './ask.js', './agent.js', './autocat.js', './sw.js', './version.js', './manifest.json', './icon.svg',
    './sync.js', './dedupe.js', './privacy.html',
...
self.addEventListener('fetch', event => {
    ...
    const networkFirst = appNavigation || sameOrigin && ['', 'index.html', 'app.js', 'lookup.js', 'ask.js', 'agent.js', 'autocat.js', 'sync.js', 'dedupe.js', 'sw.js'].some(path => url.pathname === root + path);
